...
| `pcAppDownloadUrl`<br/>[optional] | The download URL of the PC app on the desktop, used when the app is not available in the store.                              | The maximum length is 2083 characters.                                                                                           |
