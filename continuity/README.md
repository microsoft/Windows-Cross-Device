...
| `pcAppDownloadUrl`<br/>[optional] | The URI to download the PC app used to continue the app context on the PC.                                                     | Must be an `http://` or `https://` based URI. The maximum length is 2083 characters.                                            |
